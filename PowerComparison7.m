...
Macdonald model 7
Array: square
Frontal area index: 0.20

%}


uH = 1.02; % check agreement
us = 0.235;
H = 4; 
a = 1.80; % figure out how this is calculated/check agreement
kappa = 0.40;
z1 = 0:0.001:H;

d = 0.42*H; % I think this is determined experimentally?
lc = 0.1*H; % no idea 
z0 = 0.080*H; % compare to class values
