uH = 1.15; % check agreement
us = 0.23;
H = 4; 
a = 1.09; % figure out how this is calculated/check agreement
kappa = 0.40;
z1 = 0:0.001:H;

d = 0.26*H; % I think this is determined experimentally?
lc = 0.15*H; % no idea 
z0 = 0.071*H; % compare to class values
...
h = 10;
pv1 = .5*rho*u1.^3*2*r*h*cp;
pv2 = .5*rho*u2.^3*2*r*h*cp;
pv3 = .5*rho*u3.^3*2*r*h*cp;
